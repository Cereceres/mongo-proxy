...
const validate = module.exports = (data, permissions = {}, method = 'GET') => {
    ...
    console.log('_id in validate', data._id);
    console.log('keys(data) in validate', keys(data));
    ...
    return keys(data).reduce((red, prop) => {
        ...
        console.log('validate prop ', prop);
        console.log('validate permissions[prop] ', permissions[prop]);
